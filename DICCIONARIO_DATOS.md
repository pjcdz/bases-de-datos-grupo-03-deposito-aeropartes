...
| NombreUsuario | NVARCHAR(100) | NO | | Nombre | texto |
| ApellidoUsuario | NVARCHAR(100) | NO | | Apellido | texto |
| RolUsuario | NVARCHAR(50) | NO | | Rol/función | texto |
...
| NombreTipoElemento | NVARCHAR(100) | NO | AK | Nombre del tipo (único) | texto, UNIQUE |
...
| ModeloSistemaArmas | NVARCHAR(100) | NO | | Modelo / denominación | texto |
...
| DescripcionEstadoElemento | NVARCHAR(255) | SÍ | | Descripción del estado | texto |
...
| DepositoUbicacion | NVARCHAR(100) | NO | | Depósito | texto |
| SectorUbicacion | NVARCHAR(100) | SÍ | | Sector / estantería | texto |
| MapaHighlightUbicacion | NVARCHAR(255) | SÍ | | Referencia visual en el mapa | texto |
...
| DescripcionMotivoSalida | NVARCHAR(255) | SÍ | | Descripción del motivo | texto |
...
| Campo | Tipo | NULL | Clave | Descripción | Dominio / Referencia |
|---|---|---|---|---|---|
| NNE | NVARCHAR(20) | NO | PK | Número Nacional de Efecto | clave natural |
| NumeroReferenciaMaterial | VARCHAR(50) | SÍ | | Número de referencia / parte | código |
| DesignacionMaterial | NVARCHAR(255) | NO | | Denominación del material | texto |
| ATAMaterial | VARCHAR(10) | SÍ | | Capítulo ATA | código |
...
| NNE | NVARCHAR(20) | NO | PK, FK | Material | → CatalogoMateriales(NNE), ON DELETE CASCADE |
...
| NNE | NVARCHAR(20) | NO | FK | Material del catálogo | → CatalogoMateriales(NNE) |
...
| ObservacionesItem | NVARCHAR(500) | SÍ | | Observaciones | texto |
| TamanoItem | NVARCHAR(50) | SÍ | | Tamaño / medida | texto |
...
| CausasTarjeta | NVARCHAR(500) | SÍ | | Causas de rechazo/remoción | texto |
| InspectorTarjeta | NVARCHAR(100) | SÍ | | Firma/aclaración del inspector | texto |
...
| AccionMovimiento | NVARCHAR(50) | NO | | Acción registrada | texto |
| IdUsuarioRegistra | INT | SÍ | FK | Usuario que registró | → Usuarios(IdUsuario), ON DELETE SET NULL |
| DetalleMovimiento | NVARCHAR(500) | SÍ | | Detalle libre | texto |
...
| DestinoSalida | NVARCHAR(255) | SÍ | | A dónde va | texto |
...
| RetiradoPorSalida | NVARCHAR(100) | SÍ | | Persona que retiró | texto |
| ObservacionesSalida | NVARCHAR(500) | SÍ | | Observaciones | texto |
